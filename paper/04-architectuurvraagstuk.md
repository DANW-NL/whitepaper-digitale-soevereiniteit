...
## 4.2 Aanpassingen vereisen van meet af aan draagvlak
Digitale soevereiniteit zal in de regel worden gezien als een aspect dat niet direct bijdraagt aan de primaire bedrijfsdoelen, vergelijkbaar met bijvoorbeeld informatiebeveiliging, privacy en bedrijfscontinuïteit. Dat kan het dus lastig maken om het onderwerp “op de agenda te krijgen en houden.”
Anderzijds kunnen de eraan verbonden risico’s op bestuurlijk niveau niet worden genegeerd. Het is dus van belang om een goede afstemming te hebben met de leiding van de organisatie over de risico’s, risicotolerantie en de te realiseren doelen.
 ...
 * Op bedrijfsarchitectuurniveau gaat het om hoe bedrijfscontinuïteit en grip op afhankelijkheden van externe partijen is georganiseerd voor bedrijfskritische processen en concrete dienstverleners/leveranciers;
 * Op informatieniveau gaat het om het op orde zijn van informatiebeveiliging, privacy en juridische zeggenschap over informatie voor de diverse objecten, hun classificatie, en de implementatie van opslag, verwerking en uitwisseling;
 * Op applicatieniveau gaat het om koppelbaarheid, interoperabiliteit, onderhoudbaarheid, beheerbaarheid en - niet in de laatste plaats – vervangbaarheid;
 * Op het vlak van toegang en beveiliging gaat het om identiteiten, sleutelbeheer, privileged access en de rol van externe beheerders of leveranciers;
  * Op technologisch en operationeel niveau raakt het vraagstukken als continuïteit, herstelbaarheid, vervangbaarheid, interoperabiliteit, robuustheid en de beheersing van concentratie- en ketenrisico’s.

De modellen en analyses kunnen inzicht geven voor afzonderlijke keuzes, of voor afwegingen over het totaal.

## 4.5 Hoe ondersteun je besluitvorming?
...
## 4.6 Vertaling naar de praktijk
